...
if [[ "$RUN_FLOWS" == "1" ]]; then
  ...
  run "$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/backend/verify_sprints_1_2_live.py"
  run "$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/backend/verify_sprint3.py"
  run "$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/backend/verify_sprint3_live.py"
  run "$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/backend/verify_sprint4.py"
  run "$ROOT_DIR/.venv/bin/python" "$ROOT_DIR/backend/verify_sprint4_live.py"
