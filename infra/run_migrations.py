...
if __name__ == "__main__":
    ...
    try:
        ...
        files = [
            ...
            root / "backend/provider-service/src/main/resources/db/migration/V10__delivery_contacts.sql",
            root / "backend/provider-service/src/main/resources/db/migration/V11__grant_order_delivery_contact_lookup.sql",
