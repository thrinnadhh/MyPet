...
export function ProviderCompositionTemplate({
  provider,
}: {
  provider: ProviderCompositionData;
}) {
      ...
      >
        <View style={styles.heroCard}>
          ...
          <View style={styles.heroOverlay}>
            ...
            <StatusBadge
              label={`${provider.distanceKm} km away`}
              color={theme.primary}
            />
        ...
        <View style={styles.actionRow}>
          ...
          <Pressable
            onPress={() =>
              router.push(
                `/chat?recipient=${encodeURIComponent(provider.name)}` as never,
              )
            }
            style={[
              styles.actionButton,
            ...
            {provider.services.map((service) => (
              ...
              >
                ...
                <View style={styles.serviceAction}>
                  <ThemedText
                    style={[styles.fee, { color: theme.primary }]}
                  >
                    ₹{service.fee}
                  </ThemedText>
                  <Pressable
                  ...
                  >
                    <ThemedText style={styles.bookLabel}>Book</ThemedText>
                  </Pressable>
                </View>
              </View>
            ))}
