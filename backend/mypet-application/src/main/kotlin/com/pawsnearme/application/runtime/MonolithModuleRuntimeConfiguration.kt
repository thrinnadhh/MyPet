 ...
 *
 * Legacy service boot classes, per-service outbox pollers, per-service ShedLock
 * providers, gateway-trust filters and HTTP fallback adapters are deliberately
 * excluded. Public controllers and business components remain unchanged, while
 * typed module facades satisfy all in-process collaboration contracts.
 */
...
class MonolithModuleRuntimeConfiguration {
    ...
    fun monolithRestOperations(): RestOperations = RestTemplate()
