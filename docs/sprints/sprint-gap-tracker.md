...
1. Capture live proof for Sprints 4-5 using local infra and real backend services.
...
4. Re-run Sprint 1-3 proof during release regression, including Razorpay sandbox evidence for Sprint 3.
